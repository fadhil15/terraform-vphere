...
#  }
  ...
  clone {
    ...
    customize {
      ...
      network_interface {
         ipv4_address = "167.205.1.232"
         ipv4_netmask = "${var.vm_netmask}"
       }
         ipv4_gateway = "167.205.1.225"
         dns_server_list = ["167.205.23.1"]
    }
  }
  ...
  # Run commands with remote-exec over ssh
   provisioner "remote-exec" {
     inline = [
      "export http_proxy=http://167.205.22.102:7274",
      "export ftp_proxy=http://167.205.22.102:7274",
      "export https_proxy=http://167.205.22.102:7274",
      "sudo yum update -y",
      "sudo yum upgrade -y",
#      "sudo yum install php -y",
#      "sudo yum autoremove -y",
#      "sudo mkdir /root/cobafolder",
#      "sudo mkdir /root/cobafolder2",
